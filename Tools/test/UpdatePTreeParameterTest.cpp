...
BOOST_AUTO_TEST_CASE(UpdatePTreeParameterTest) {
  ...
  auto FitStrength = ComPWA::FitParameter<double>(Strength, 0.5, 0.0, 1.0);
  auto FitMagnitudeL0S1 =
      ComPWA::FitParameter<double>(MagnitudeL0S1, 1.0, 0.0, 10.0);
  auto FitPhaseL0S1 = ComPWA::FitParameter<double>(PhaseL0S1, 0.0, -3.14, 3.14);
  auto FitMagnitudeL2S1 =
      ComPWA::FitParameter<double>(MagnitudeL2S1, 3.0, 0.0, 10.0);
  auto FitPhaseL2S1 = ComPWA::FitParameter<double>(PhaseL2S1, 1.2, -3.14, 3.14);
